    ...
    items.push({
      ...
      component: (
        <Button
          ...
          size="sm"
          className="w-24"
          onPress={() => router.push(`/${pluralize(kebabCase(model) || "")}/edit/${row.id}/fields`)}
        >
          افزودن فیلد
        </Button>
      ),
    ...
    items.push({
      ...
      component: (
        <Button
          ...
          size="sm"
          className="w-24"
          startContent={<PlusCircleIcon className="w-4" />}
          onPress={() => router.push(`/contents/create?category_id=${row.id}`)}
        >
          افزودن محتوا
        </Button>
      ),
